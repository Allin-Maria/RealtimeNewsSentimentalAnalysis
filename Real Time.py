...
"""First, we'll save the Python code from the previous cell into a file named `app.py`."""
...
export NEWSAPI_KEY="a009d11222b65976709401fd2ae19baf"

!export NEWSAPI_KEY="a009d11222b65976709401fd2ae19baf"

import os
url = f"https://newsapi.org/v2/top-headlines?country=us&apiKey={os.environ.get('NEWSAPI_KEY')}"
print(url)